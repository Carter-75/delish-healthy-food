  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-1/4 left-1/4 w-96 h-96 ${theme.accent || 'bg-blue-500'} rounded-full 
          opacity-10 blur-3xl animate-float`} />
        <div className={`absolute bottom-1/4 right-1/4 w-96 h-96 ${theme.accent || 'bg-purple-500'} rounded-full 
