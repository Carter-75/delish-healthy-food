  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto relative">
        ...
        {/* Coming Soon Overlay with Radial Blur Effect */}
        <div className="absolute inset-0 flex items-center justify-center z-50 pointer-events-none overflow-hidden">
          {/* Base backdrop blur */}
          <div className="absolute inset-0 bg-slate-900/30" style={{ backdropFilter: 'blur(8px)' }}></div>
          
          {/* Center spot - strongest blur */}
          <div className="absolute top-1/2 left-1/2 w-[900px] h-[900px]" style={{ background: 'radial-gradient(circle, rgba(59, 130, 246, 0.4) 0%, rgba(147, 51, 234, 0.25) 30%, rgba(236, 72, 153, 0.15) 50%, transparent 70%)', filter: 'blur(120px)', transform: 'translate(-50%, -50%)' }}></div>
          
          {/* Secondary blur spots */}
          <div className="absolute top-1/3 left-1/4 w-[700px] h-[700px]" style={{ background: 'radial-gradient(circle, rgba(139, 92, 246, 0.3) 0%, rgba(99, 102, 241, 0.15) 40%, transparent 70%)', filter: 'blur(100px)', transform: 'translate(-30%, -20%)' }}></div>
          <div className="absolute bottom-1/3 right-1/4 w-[700px] h-[700px]" style={{ background: 'radial-gradient(circle, rgba(236, 72, 153, 0.3) 0%, rgba(147, 51, 234, 0.15) 40%, transparent 70%)', filter: 'blur(100px)', transform: 'translate(30%, 20%)' }}></div>
          
          {/* Edge blur spots */}
          <div className="absolute top-0 right-0 w-[500px] h-[500px]" style={{ background: 'radial-gradient(circle, rgba(34, 211, 238, 0.2) 0%, rgba(59, 130, 246, 0.1) 50%, transparent 70%)', filter: 'blur(90px)', transform: 'translate(25%, -25%)' }}></div>
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px]" style={{ background: 'radial-gradient(circle, rgba(217, 70, 239, 0.2) 0%, rgba(192, 132, 252, 0.1) 50%, transparent 70%)', filter: 'blur(90px)', transform: 'translate(-25%, 25%)' }}></div>
          
          {/* Ambient blur overlay */}
          <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at center, rgba(59, 130, 246, 0.08) 0%, rgba(147, 51, 234, 0.06) 50%, transparent 100%)', filter: 'blur(60px)' }}></div>
